...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form");a.addEventListener("input",(0,e.default)(o,500)),a.addEventListener("submit",n);const r="feedback-form-state";let l={};function n(e){e.preventDefault();const t=e.target.elements,n=t.email.value,o=t.message.value;return""===o&&""===n?alert('Поля "email" та "message" мають бути заповнені!'):""===n?alert('Поле "email" мають бути заповнені!'):""===o?alert('Поле "message" мають бути заповнені!'):(l={email:n,message:o},console.log(l),a.reset(),void localStorage.removeItem(r))}function o(e){l[e.target.name]=e.target.value,localStorage.setItem(r,JSON.stringify(l))}function s(){let e=localStorage.getItem(r);e&&(e=JSON.parse(e),Object.entries(e).forEach(([e,t])=>{l[e]=t,a.elements[e].value=t}))}inForm();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.ac09437f.js.map